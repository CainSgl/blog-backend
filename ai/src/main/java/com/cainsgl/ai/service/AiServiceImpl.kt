...
import com.cainsgl.ai.util.EmbeddingUtils
import com.cainsgl.ai.util.EmbeddingUtils.reduceDimension
...
class AiServiceImpl : AiService
{
    ...
    override fun getEmbedding(text: String): FloatArray
    {
        ...
        return reduceDimension(embed, dimensions)
    }

    override fun getEmbedding(texts: List<String>): List<FloatArray>
    {
        val embeds = embeddingModel.embed(texts)
        return EmbeddingUtils.reduceDimensionBatch(embeds, dimensions)
    }
}
